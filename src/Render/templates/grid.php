 ...
 *   $attrs   — shortcode/block attributes (layout, per_page, pagination, …)
 *   $renderer — VideoRenderer instance (helper for embed URLs, durations)
 *
 * Phase 4.0 ships a minimal CSS class set. The bundled CSS (vyg-grid.css)
 * ships sane defaults; themes can override in their own stylesheet.
 *
 * @var array $source
 * @var array $videos
 * @var array $attrs
